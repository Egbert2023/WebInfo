...
// ---------------------------------------------------------------------------
    var newsList = [
...

        {
            ...
            img: ["content/fegh/pictures/Landesfoerderung.jpg"],
            imgBody: [],
            href: ""
        },
        {
        ...
        },
        {
            ...
            img: ["content/fegh/pictures/teilnehmende-der-radtour-stehen-im-kreis-um-barbara-rodi-vorstand-der-energiegenossenschaft.jpg",
                  "content/fegh/pictures/6-personen-oben-auf-dem-reesberg-mit-solarmodulen-im-hintergrund-das-panorama-kirchlengern-und-löhne.jpg"],
...

        {
            ...
            img: ["content/fegh/pictures/Kanal21-Interview.png"],
            imgBody: [],
            href: ""
        },
        {
        ...
        },
        {
            ...
            img: ["content/fegh/pictures/ostereiersuche-am-ostermontag-mit-einigen-teilnehmenden-und-aktiven-der-fegh-eg.jpg"],
...
var getImgBoxList = function() {
    var imgBoxList = [
        {   imgKey: 'Hainkamp',
            ...
            imgList: ["content/fegh/pictures/pro/HainkampLuftaufnahme.png",
                           "content/fegh/pictures/pro/GruppeMitLogoPlakat.jpg",
                           "content/fegh/pictures/pro/HainkampKarte.png"]
        },
        {   imgKey: 'Home',
            imgBodyList: ["Mitglieder der Genossenschaft"],
            imgList: ["content/fegh/pictures/gruppenfoto-fegheg.jpg"]
        },
        {   imgKey: 'anyOther',
            imgBodyList: [],
            imgList: []
...
var getObjBg = function() {        
    ...
    var pic = [ "url(content/fegh/pictures/Solardach-mit-Blume.jpg)", 
            "url(content/fegh/pictures/Solaranlage-mit-hängenden-Kablen.jpg)", 
            "url(content/fegh/pictures/Solardach-im-Winter.jpg)", 
            "url( content/fegh/pictures/Lichter-am-Haus.jpg)", 
            "url( content/fegh/pictures/große-photovoltaik-anlage.jpg)", 
            "url( content/fegh/pictures/Solarreinigung-auf-einem-Dach-Download.jpg)", 
            "url( content/fegh/pictures/gruppenfoto-fegheg.jpg)"
        ];
    var objBg = {};
