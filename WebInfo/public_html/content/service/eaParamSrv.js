...
// ---------------------------------------------------------------------------
    var newsList = [
...

        {
            ...
            img: ["content/pictures/Landesfoerderung.jpg"],
            imgBody: [],
            href: ""
        },
        {
            ...
            img: ["content/pictures/Coaching-Gruppe.jpg"],
            imgBody: [],
            href: ""
        },
        {
            ...
            img: ["content/pictures/teilnehmende-der-radtour-stehen-im-kreis-um-barbara-rodi-vorstand-der-energiegenossenschaft.jpg",
                  "content/pictures/6-personen-oben-auf-dem-reesberg-mit-solarmodulen-im-hintergrund-das-panorama-kirchlengern-und-löhne.jpg"],
        ...
        },
        {
            ...
            body: [], 
            img: ["content/pictures/foto-mit-den-15-teilnehmenden-frauen-am-balkonkraftwerke-workshop-mit-balkonkraftwerk.jpg"],
            imgBody: [],
            href: ""
        },
        {
        ...
        },
        {
            ...
            img: ["content/pictures/ostereiersuche-am-ostermontag-mit-einigen-teilnehmenden-und-aktiven-der-fegh-eg.jpg"],
...
var getNaviList = function() {
    var naviList = [
        ...
        {id:"navErg", label: "Öko-Energie", href: "#!/erg",  url: "content/html/erg.html",
            subm: [ {label: "Bürger-Ökostrom", href: "#!/erg/1", url: "content/html/erg/erg0001.html"},
                    {label: "Bürger-Ökogas", href: "#!/erg/2", url: "content/html/erg/erg0002.html"}                                                        
                                               ]},
        {id:"navWir", label: "Wir", href: "#!/wir", url: "content/html/wir.html",
            subm: [ {label: "Kontakt", href: "#!/wir/1", url: "content/html/wir/wir0001.html"},
                    {label: "Philosophie", href: "#!/wir/2", url: "content/html/wir/wir0002.html"}, 
                    {label: "Satzung", href: "#!/wir/3", url: "content/html/wir/wir0003.html"}
                                             ]},                                                    
        {id:"navNews", label: "News", href: "#!/new", url: "content/html/news.html", 
            subm: [ {label: "Archiv", href: "#!/new/1", url: "content/html/new/newArchiv.html"}]},

        {id:"navProj", label: "Projekte", href: "#!/pro", url: "content/html/projects.html", 
            subm: [ {id: "navProHk", label: "Hainkamp", href: "#!/pro/hk", url: "content/html/pro/Hainkamp.html", 
                        subm: [{label: "Tagebuch", href: "#!/pro/hk/tb", url: "content/html/pro/HainkampTagebuch.html"}]},
                
                    {id: "navProD", label: "Bauschuttdeponie Reesberg", href: "#!/pro/1", url: "content/html/pro/Bauschuttdeponie-Reesberg.html", 
                        subm: [{label: "Projektbeschreibung", href: "#!/pro/1/1", url: "content/html/pro/ProjektbeschreibungR.html"}]},
                    {label: "Erich-Gutenberg- Berufskolleg", href: "#!/pro/2", url: "content/html/pro/pro0002.html"},
                    {label: "Bergs Hof", href: "#!/pro/3", url: "content/html/pro/pro0003.html"},
                    {label: "Kindergarten Haus Lukas", href: "#!/pro/4", url: "content/html/pro/pro0004.html"},
                    {label: "Kreissporthalle Herford", href: "#!/pro/5", url: "content/html/pro/pro0005.html"},
                    {label: "Luise Scheppler Kindergarten", href: "#!/pro/6", url: "content/html/pro/pro0006.html"},
                    {label: "B u. S Bünde", href: "#!/pro/7", url: "content/html/pro/pro0007.html"},
                    {label: "Gärtnerei Ulenburg und Familie Esser", href: "#!/pro/8", url: "content/html/pro/pro0008.html"},
                    {label: "Reiterhof Kahre", href: "#!/pro/9", url: "content/html/pro/pro0009.html"},
                    {label: "Bahnhof Bieren", href: "#!/pro/10", url: "content/html/pro/pro0010.html",
                        subm: [{label: "Details 1", href: "#!/pro/10/1", url: "content/html/pro/pro0010-1.html"},
                               {label: "Details 2", href: "#!/pro/10/2", url: "content/html/pro/pro0010-2.html"}]},
                    {label: "Familie Beversdorff", href: "#!/pro/XX", url: "content/html/pro/pro00XX.html"}
            ]},

        {id:"navSrv", label: "Service", href: "#!/srv", url: "content/html/service.html", 
            subm: [ {label: "Beititt", href: "#!/srv/1", url: "content/html/srv/srv0001.html"},
                    {label: "Anteilserhöhung", href: "#!/srv/2", url: "content/html/srv/srv0002.html"},
                    {label: "Downloads", href: "#!/srv/3", url: "content/html/srv/srv0003.html"},
                    {label: "Impressum", href: "#!/impressum", url: "content/html/Impressum.html"},
                    {label: "Cookies", href: "#!/cookies", url: "content/html/CookiesNotRequired.html"}
                  ]
        }
...
var getImgBoxList = function() {
    var imgBoxList = [
        {   imgKey: 'Hainkamp',
            ...
            imgList: ["content/pictures/pro/HainkampLuftaufnahme.png",
                           "content/pictures/pro/GruppeMitLogoPlakat.jpg",
                           "content/pictures/pro/HainkampKarte.png"]
        },
        {   imgKey: 'Home',
            imgBodyList: ["Mitglieder der Genossenschaft"],
            imgList: ["content/pictures/gruppenfoto-fegheg.jpg"]
        },
        {   imgKey: 'anyOther',
            imgBodyList: [],
            imgList: []
    ...
    var projectList = [
        {
            ...
            href: "#!/pro/1",
            templateUrl: "content/html/pro/pro0001"
        }
...
var getObjBg = function() {        
    ...
    var pic = [ "url(content/pictures/Solardach-mit-Blume.jpg)", 
            "url(content/pictures/Solaranlage-mit-hängenden-Kablen.jpg)", 
            "url(content/pictures/Solardach-im-Winter.jpg)", 
            "url( content/pictures/Lichter-am-Haus.jpg)", 
            "url( content/pictures/große-photovoltaik-anlage.jpg)", 
            "url( content/pictures/Solarreinigung-auf-einem-Dach-Download.jpg)", 
            "url( content/pictures/gruppenfoto-fegheg.jpg)"
        ];
    var objBg = {};
